...
def main(args):
	...
	for file in files:
		...
		command = f'ffmpeg -i "{file}" -ab 320k -map_metadata 0 -id3v2_version 3 "{destpath}"'
...
if __name__ == "__main__":
	...
	parser.add_argument("-f", "--filter", help="pattern to filter files (default '*.flac').")
